...
function App() {
  ...
  return (
    <div>
      <ReviewBlock
        name={sampleData[arrayIndex].name}
        lastname={sampleData[arrayIndex].lastname}
        pictureSource={sampleData[arrayIndex].pictureSource}
        standout={sampleData[arrayIndex].standout}
        reviewSummary={sampleData[arrayIndex].reviewSummary}
        reviewDescription={sampleData[arrayIndex].reviewDescription}
        customStyle={4}
      />
    </div>
  );
